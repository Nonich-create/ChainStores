...
<body>
    ...
    <form id="form1" runat="server" onload="form1_Load">
      ...
      <div style="width:300px;margin:0 auto;outline: 2px solid #000;padding: 10px;border-radius: 10px;">   
        ...
        <asp:Button ID="ButtonSave" Text="Save" runat="server" OnClientClick="CheckValidation('errorSummary','validationSum')" OnClick="ButtonSave_Click" CssClass="btn btn-primary" />
