...
<body>
    <form id="form1" runat="server">    
        ...
        <asp:Button ID="ButtonSave" OnClientClick="CheckValidation('errorSummary','validationSum')" Text="Save" runat="server" CssClass="btn btn-primary" OnClick="ButtonAdd_Click" />
